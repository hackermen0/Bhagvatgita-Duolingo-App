...
<div class="flex flex-col gap-3 w-full select-none max-w-lg mx-auto">
  ...
  <div class="min-h-[85px] w-full border-2 border-dashed border-border-warm bg-bg-surface rounded-2xl p-3 flex flex-wrap gap-2 items-center justify-center content-center transition-all">
  ...
  <!-- Divider line -->
  <div class="h-px bg-border-warm my-0.5"></div>
